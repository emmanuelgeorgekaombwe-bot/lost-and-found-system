    ...
    if (empty($item_name) || empty($category_id) || empty($description) || empty($location) || empty($date_occurred) || empty($contact_phone)) {
        ...
        if (!empty($_FILES['item_photo']['name'])) {
            ...
            if (!in_array($ext, $allowed)) {
                ...
                $filename   = 'lost_' . time() . '_' . $user_id . '.' . $ext;
        ...
        if (empty($error)) {
            ...
            if (mysqli_query($conn, $sql)) {
                $success = 'Your lost item has been reported successfully. We will notify you if a match is found.';
            } else {
...
<head>
    ...
    <title>Report Lost Item — CBE Lost & Found</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <a href="report_lost.php" class="menu-item active"><span class="menu-icon">📋</span> Report Lost Item</a>
...
<main class="main">
    <div class="page-header">
        ...
        <p class="page-sub">Provide as much detail as possible to increase the chances of recovery.</p>
    </div>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description"
                          placeholder="Describe the item in detail — any unique features, stickers, damage, or markings that identify it."
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="brand" name="brand"
                           placeholder="e.g. Samsung, HP, Adidas"
                           value="<?php echo isset($_POST['brand']) ? htmlspecialchars($_POST['brand']) : ''; ?>">
                </div>
            </div>

            <hr class="section-divider">
            <h3 class="section-heading">Where & When</h3>

            <div class="form-row">
                <div class="form-group">
                    <label for="location">Last Known Location <span class="required">*</span></label>
                    <input type="text" id="location" name="location"
                           placeholder="e.g. CBE Library, Block B Classroom"
                           value="<?php echo isset($_POST['location']) ? htmlspecialchars($_POST['location']) : ''; ?>"
                           required>
                </div>
                <div class="form-group">
                    <label for="date_occurred">Date Lost <span class="required">*</span></label>
            ...
            <hr class="section-divider">
            <h3 class="section-heading">Photo (Optional)</h3>
            ...
            <div class="form-group">
                <label class="file-upload" for="item_photo">
                    ...
                    <div class="file-upload-text" id="file-label">
                        <strong>Click to upload a photo</strong> or drag and drop<br>
                        JPG, PNG or GIF — max 2MB
                    </div>
                </label>
                <p class="hint">A photo significantly increases the chances of your item being identified.</p>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact_phone" name="contact_phone"
                       ...
                       required>
                <p class="hint">This number will be shared with the admin and finder so they can contact you when your item is found.</p>
            </div>
